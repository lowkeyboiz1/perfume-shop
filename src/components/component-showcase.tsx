...
export function ComponentShowcase() {
  ...
  return (
    <section id='components' className='mt-16'>
      <h2 className='mb-8 text-3xl font-bold'>Component Examples</h2>
        ...
        <EnhancedCard gradient>
          ...
          <EnhancedCardContent>
            <div className='space-y-4'>
              ...
              {showMore && (
                <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} exit={{ opacity: 0, height: 0 }} className='space-y-2 pt-4'>
                  <p className='text-sm text-muted-foreground'>Your usage has increased by 23% compared to last month.</p>
                  <div className='flex gap-2'>
                    <div className='flex-1 rounded-md bg-primary/10 p-3 text-center'>
